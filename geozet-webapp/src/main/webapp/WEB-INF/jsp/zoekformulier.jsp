...
<form id="geozetCoreEntree"	action="<%=getServletContext().getInitParameter(StringConstants.CONFIG_PARAM_GEOZETSERVLET.code)%>" method="post" title="Zoekformulier"><%=RESOURCES.getString("KEY_ZOEKEN_TITEL")%>
